    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      >
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            <span className="font-bold text-primary">Movie Vault</span> itself
            is ad-free. However, the APIs we aggregate from often inject scripts
            within their iframes to display popups and or ads.
          </AlertDialogDescription>
        </AlertDialogHeader>
