...
const whyList: WhyProps[] = [
  ...
  },
  {
    ...
    description:
      "Movie Vault is open source, so you can contribute to the project and make it even better.",
  },
  {
    icon: "TrendingUp",
      ...
      <div className="grid lg:grid-cols-2 place-items-center lg:gap-24">
        <div>
          ...
          <p className="text-xl text-muted-foreground mb-8">
            ...
            statements into a horror movie. With Movie Vault, you can watch your
