...
export const metadata = {
  title: "Terms of Service - Movie Vault",
  description: "Terms of Service for Movie Vault streaming platform",
};
          ...
          <LegalPage title="Terms of Service">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault is released under the MIT License and is available
                on GitHub for anyone to review, use, or contribute to.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using Movie Vault, you accept and agree to be
                bound by these terms and conditions. If you do not agree with
                these terms, please do not use this service. Since Movie Vault
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Movie Vault provides the following services:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Permission is granted to access Movie Vault for personal,
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                <strong>Important:</strong> Movie Vault links to external video
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Movie Vault is not responsible for the content, practices, or
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                All movie and TV show information displayed on Movie Vault is
                sourced from:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                As a user of Movie Vault, you are responsible for:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault is provided "as is" without any warranties,
                expressed or implied. We make no warranties regarding:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault and its contributors shall not be liable for any
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                use of Movie Vault after changes constitutes acceptance of the
                new terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                support@streamx.app. As an open-source project, we welcome
