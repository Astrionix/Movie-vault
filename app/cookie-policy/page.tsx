...
export const metadata = {
  title: "Cookie Policy - Movie Vault",
  description: "Cookie Policy for Movie Vault streaming platform",
};
      ...
      <div className="relative z-10 min-h-[100dvh] w-full">
        <ContentContainer className="w-full flex flex-col items-center">
          <LegalPage title="Cookie Policy">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                How Movie Vault Uses Cookies
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Movie Vault uses cookies for essential functionality and
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Movie Vault explicitly does NOT use:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Movie Vault has no control over cookies used by external
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                If you disable cookies on Movie Vault:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                at privacy@streamx.app. We're committed to transparency and
                privacy in our open-source project.
              </p>
            </section>
          </LegalPage>
        </ContentContainer>
