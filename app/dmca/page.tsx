...
export const metadata = {
  title: "DMCA Policy - Movie Vault",
  description:
    "DMCA Policy and Copyright Information for Movie Vault streaming platform",
};
          ...
          <LegalPage title="DMCA Policy">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                About Movie Vault & Copyright
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Movie Vault is a free, open-source movie and TV show discovery
                platform.{" "}
                <strong>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content information displayed on Movie Vault comes from The
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                What Movie Vault Actually Does
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Movie Vault respects intellectual property rights and complies
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                buttons on Movie Vault, they are directed to external,
                independent websites and video players (such as 2embed and
                others). These external sites:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>Are completely independent from Movie Vault</li>
                <li>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong>
                  Movie Vault is not responsible for content hosted on external
                  streaming sites.
                </strong>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                All movie and TV show information on Movie Vault comes from
                legitimate sources:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                If you believe that information or images displayed on Movie
                Vault infringe your copyright, please provide:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-black/30 border border-white/20 rounded-lg p-6 mb-4">
                ...
                <p className="text-muted-foreground">
                  Email: dmca@streamx.app
                  <br />
                  Subject: "Copyright Inquiry - Movie Vault"
                </p>
              </div>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                While Movie Vault has no user accounts or user-generated
                content, we maintain a policy of removing persistent infringing
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault operates under fair use principles by:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault is open source software released under the MIT
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault and its contributors are not liable for:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4 mt-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault is available globally and respects international
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                For copyright-related inquiries, please contact our team at
                dmca@streamx.app. We are committed to addressing legitimate
                copyright concerns promptly and fairly while maintaining our
                role as a content discovery platform.
              </p>
            </section>
          </LegalPage>
        </ContentContainer>
