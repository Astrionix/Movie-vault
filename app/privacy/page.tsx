...
export const metadata = {
  title: "Privacy Policy - Movie Vault",
  description: "Privacy Policy for Movie Vault streaming platform",
};
          ...
          <LegalPage title="Privacy Policy">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                <strong>No Account Required:</strong> Movie Vault does not
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Since Movie Vault has no user accounts or registration system,
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Movie Vault integrates with several external services:
              </p>
              ...
              <div className="mb-6">
                ...
                <p className="text-muted-foreground leading-relaxed mt-2">
                  <strong>Important:</strong> Movie Vault is not responsible for
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Since Movie Vault doesn't require accounts or collect personal
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Movie Vault itself is completely ad-free. However, when you
                visit external video players or streaming sites that we link to,
                those sites may display their own advertisements. We have no
                control over these external ads and are not responsible for
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Since Movie Vault doesn't collect personal information from
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                us at privacy@streamx.app. As an open-source project, we're
